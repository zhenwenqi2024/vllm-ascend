...
| `dfx_config`                        | dict | `{}`    | Disabled-by-default MRV1/MRV2 DFX with host history and separately enabled device probes. See [KV-centered DFX](../../developer_guide/host_flight_recorder.md) for limits, coverage and export. |
